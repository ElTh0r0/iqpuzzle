...
* [Build for macOS](https://github.com/ElTh0r0/iqpuzzle/releases/download/v1.5.0/iQPuzzle-1.5.0-macOS.zip)
* [Linux AppImage](https://github.com/ElTh0r0/iqpuzzle/releases/download/v1.5.0/iQPuzzle-1.5.0-x86_64.AppImage)
...
* [Build for ReactOS](https://github.com/ElTh0r0/iqpuzzle/releases/download/v1.5.0/iQPuzzle-1.5.0-ReactOS_Installer.exe)
...
New translations and corrections are highly welcome! You can either fork the source code, make your changes and create a pull request or you can participate on [translate.codeberg.org](https://translate.codeberg.org/engage/iqpuzzle/).

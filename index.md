...
# [](#downoads)Downloads
###### Latest release v1.1.5 (02. Nov 2019)
* [Build for Windows - Installer](https://github.com/ElTh0r0/iqpuzzle/releases/download/v1.1.5/iQPuzzle-1.1.5-Windows_Installer.exe)
* [Build for Windows - ZIP](https://github.com/ElTh0r0/iqpuzzle/releases/download/v1.1.5/iQPuzzle-1.1.5-Windows.zip)
* [Build for macOS](https://github.com/ElTh0r0/iqpuzzle/releases/download/v1.1.5/iQPuzzle-1.1.5-macOS.zip)
* [Linux AppImage](https://github.com/ElTh0r0/iqpuzzle/releases/download/v1.1.5/iQPuzzle-1.1.5-x86_64.AppImage)
...
* [Build for ReactOS](https://github.com/ElTh0r0/iqpuzzle/releases/download/v1.1.5/iQPuzzle-1.1.5-ReactOS_Installer.exe)
